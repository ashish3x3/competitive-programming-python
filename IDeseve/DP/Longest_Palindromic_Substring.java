...
/*
better explnaton for why a[i+1][j-1] http://www.geeksforgeeks.org/longest-palindrome-substring-set-1/
if EE matches, then table[1][2] i.e matched char index will be sett to true iint able
