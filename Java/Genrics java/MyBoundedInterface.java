public class MyBoundedInterface {
    ...
    public static void main(String a[]){
        ...
        //becasue we restricted to only of type X  implementation classes. i.e wehave ti extend x and string is not extending interface x.
...
- See more at: http://java2novice.com/java-generics/implements-interface/#sthash.kbSozA8F.dpuf*/